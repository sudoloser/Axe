...
import com.my.axe.data.remote.ApiResponse
import com.my.axe.data.remote.ExternalAsset
import com.my.axe.data.remote.ImgurResponse
...
fun Context.shareFile(file: File?) {
    if (file == null) return
    val uri = FileProvider.getUriForFile(this, "com.my.axe.provider", file)
