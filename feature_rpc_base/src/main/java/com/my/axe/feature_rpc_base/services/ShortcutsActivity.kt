...
class ShortcutsActivity : Activity() {
        ...
        intent?.action?.let {
            when (it) {
                Intents.START_APP_DETECTION_SHORTCUT -> {
                    ...
                    Toast.makeText(
                        this, getString(R.string.start_appDetection_toast), Toast.LENGTH_SHORT
                    ).show()
                }
                ...
                Intents.START_MEDIA_RPC_SHORTCUT -> {
                    ...
                    Toast.makeText(
                        this, getString(R.string.start_mediaRPC_toast), Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    companion object {
        object Intents {
            val START_APP_DETECTION_SHORTCUT = "com.my.axe.intent.action.START_APP_DETECTION"
            val START_MEDIA_RPC_SHORTCUT = "com.my.axe.intent.action.START_MEDIA_RPC"
            val START_EXPERIMENTAL_RPC_SHORTCUT =
                "com.my.axe.intent.action.START_EXPERIMENTAL_RPC"
            val STOP_RPC = "com.my.axe.intent.action.STOP_RPC"
        }
    }
}